...
const ToastComponent: React.FC<Toast> = ({ message, type }) => {
  const typeConfig = {
    success: { icon: CircleCheck, bgColor: 'bg-white', textColor: 'text-green-700', borderColor: 'border-green-300' },
    error: { icon: AlertCircle, bgColor: 'bg-white', textColor: 'text-red-700', borderColor: 'border-red-300' },
    warning: { icon: AlertTriangle, bgColor: 'bg-white', textColor: 'text-yellow-700', borderColor: 'border-yellow-300' },
    info: { icon: Info, bgColor: 'bg-white', textColor: 'text-blue-700', borderColor: 'border-blue-300' }
  };
