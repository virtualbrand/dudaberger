                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          // Gerar slug automaticamente apenas se for uma nova proposta e o slug não foi editado manualmente
                          if (selectedProposta.id.startsWith('new-') && !slugWasAutoGenerated) {
                            const autoSlug = createSlug(newValue);
                            setSelectedProposta({ ...selectedProposta, clienteNome: newValue, slug: autoSlug });
                          } else {
                            setSelectedProposta({ ...selectedProposta, clienteNome: newValue });
                          }
                        }}
                        disabled={!isEditing}
