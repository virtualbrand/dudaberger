...
export default function LeadsPage() {
  ...
  React.useEffect(() => {
    if (!loading && !isAuthenticated) {
      console.log('Leads: Não autenticado, redirecionando para login');
      router.push('/login');
    }
  ...
  if (!isAuthenticated) {
    console.log('Leads: Usuário não autenticado');
    return null;
  }

  console.log('Leads: Renderizando com usuário:', user?.email);
